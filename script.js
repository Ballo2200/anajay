  ...
  const admins = [
    ...
    { code: "2712", name: "عبدالله", password: "01007001578", role: "admin" },
  ...
  function showCustomerTransactions(customerId) {
    ...
    function addOrder(event) {
      ...
      const currentUser = localStorage.getItem('currentUser') || 'غير محدد';
      ...
      if (order) {
        ...
        detailsBody.innerHTML = `
          ...
          <div class="row mb-2">
            ...
            <div class="col-8">${order.createdBy && order.createdBy !== 'undefined' ? order.createdBy : 'غير محدد'}</div>
          </div>
          <div class="row mb-2">
            ...
            <div class="col-8">
              ${(() => {
                ...
                console.log('قيمة lastModifiedBy:', modifier, 'نوع البيانات:', typeof modifier);
...
?text=${encodeURIComponent(`السلام عليكم استاذ ${technician.name.split(' ')[0]}\nلقد وصلت للحد الاقصي للتعامل ارجاء تصفيه الحساب البالغ ${totalCompanyShare.toFixed(2)} ج من خلال فودافون كاش رقم 01062644606 او التوجه الي المكتب لتصفيه الحساب\nمع تحيات اداره انا جاي`)}"><i class='bi bi-whatsapp'></i> واتساب</a>` : ''}
  ...
  function addVipCard(event) {
    ...
    const newCard = {
      ...
      createdBy: localStorage.getItem('currentUser') || 'غير محدد',
      status: 'نشط'
    };
  ...
  function useVipCard() {
    ...
    const usageRecord = {
      ...
      usedBy: localStorage.getItem('currentUser') || 'غير محدد',
      cardType: card.type
    };
  ...
  function updateVipCard(event) {
    ...
    cards[cardIndex] = {
      ...
      expiryDate: expiryDate,
      notes: notes,
      lastModifiedBy: localStorage.getItem('currentUser') || 'غير محدد',
    ...
    modal.innerHTML = `
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>نموذج إضافة طلب جديد سيظهر هنا.</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إغلاق</button>
